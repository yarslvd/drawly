...
import { EraserLine } from "@/data/Shapes/EraserLine";
...
export class Eraser extends Tool {
  ...
  protected onMove(start: Coordinates, end: Coordinates): void {
    ...
    const line = new EraserLine(this.canvas, this.points, this.canvas.options);
  ...
  protected onDown(point: Coordinates): void {
    ...
    const line = new EraserLine(this.canvas, this.points, 5, "black");
    line.onDraw();
    this.canvas.pushHistory(line);
  }
